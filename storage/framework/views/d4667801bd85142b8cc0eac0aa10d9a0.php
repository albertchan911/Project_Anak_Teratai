...
<!-- Form Pencarian -->
<form method="GET" action="<?php echo e(route('dashboard')); ?>" class="flex flex-wrap gap-4 mb-6 items-center">
    <!-- Input Cari Nama (Lebar sama dengan filter lainnya) -->
    <div class="flex flex-col w-full sm:w-1/4">
        <input type="text" name="search" placeholder="Cari Nama" value="<?php echo e(request('search')); ?>"
    ...
    <div class="flex flex-col w-full sm:w-1/6">
        <select name="kelas" id="kelas" class="p-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-400 w-full" onchange="this.form.submit()">
            ...
            <?php for($i = 1; $i <= 12; $i++): ?>
                <option value="<?php echo e($i); ?>" <?php echo e(request('kelas') == $i ? 'selected' : ''); ?>><?php echo e($i); ?></option>
            <?php endfor; ?>
        </select>
    </div>
    ...
    <div class="flex flex-col w-full sm:w-1/4">
        <select name="sekolah" id="sekolah" class="p-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-400 w-full" onchange="this.form.submit()">
            ...
            <?php $__currentLoopData = $sekolahs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sekolah): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($sekolah->sekolah); ?>" <?php echo e(request('sekolah') == $sekolah->sekolah ? 'selected' : ''); ?>>
                    <?php echo e($sekolah->sekolah); ?>
    ...
    <!-- Tombol Export Data -->
    <div class="flex flex-col w-full sm:w-1/6">
        <a href="<?php echo e(route('dashboard.export', request()->all())); ?>" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">
            Export Data
        </a>
    </div>
                ...
                <?php $__currentLoopData = $siswas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $siswa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="hover:bg-gray-100">
                        <td class="px-6 py-4 font-medium text-blue-600">
                            <a href="<?php echo e(route('profile.show', $siswa->id)); ?>" class="hover:underline">
                        ...
                        <td class="px-6 py-4"><?php echo e($siswa->kelas); ?></td>
                        <td class="px-6 py-4"><?php echo e($siswa->sekolah); ?></td>
                        <td class="px-6 py-4"><?php echo e($siswa->he_qi); ?></td>
                        <td class="px-6 py-4">
...
<td class="px-6 py-4">
        <a href="<?php echo e(route('nilai.create', $siswa->id)); ?>" 
    ...
    <p class="text-lg font-semibold">Total Siswa: <?php echo e($totalSiswa); ?></p>
</div>
...
<div class="bg-white rounded-xl shadow-md p-6 mt-6"> <!-- Menambahkan mt-6 untuk margin top -->
    ...
    <form action="<?php echo e(route('siswa.import')); ?>" method="POST" enctype="multipart/form-data" class="mb-6">
        <?php echo csrf_field(); ?>
        <div class="flex items-center space-x-4">
            ...
            <a href="<?php echo e(asset('storage/templates/Template_Excel.xlsx')); ?>" download>
    ...
    <?php if($errors->has('file')): ?>
        <p class="text-red-600 mt-2"><?php echo e($errors->first('file')); ?></p>
    <?php endif; ?>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\tugas\Project_Anak_Teratai\resources\views/dashboard.blade.php ENDPATH**/ ?>